...
Пет проект разработан на основе продуктового подхода: от анализа потребностей пользователей и моделирования сквозного бизнес-процесса до проектирования физической схемы данных и реализации API.

### 🗺 Карта пользовательских историй (User Story Map)
Перед проектированием базы данных была выстроена верхнеуровневая структура требований к мобильному приложению ТСД. 
...
На основе бизнес-процесса спроектирована реляционная модель данных (в третьей нормальной форме), описывающая сущности e-commerce логики. Диаграмма наглядно отображает связи «многие-ко-многим» между заказами и товарной номенклатурой.
