...
Проект демонстрирует проектирование реляционной базы данных, бизнес процесс, функциональные требования и описание интеграционного взаимодействия.
...
* Для просмотра спецификации API откройте файл `openapi.yaml` в Swagger Editor
